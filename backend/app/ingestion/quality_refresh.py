...
def _refresh_quality(data_dir: str | Path, limit: int | None = None) -> dict[str, int]:
    ...
    for r in targets:
        ...
        # The business model and its caveat travel with the score: a bank scored against the
        # adaptive framework has metrics marked N/A and its maximum renormalised, and the page
        # has to be able to say so rather than show a bare number.
        _ad = q.adaptive or {}
