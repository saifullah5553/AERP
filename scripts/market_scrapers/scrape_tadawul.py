"""Download Saudi (Tadawul) financial statements from stockanalysis.com.

Simple and self-contained. One browser, one page, one symbol at a time.

    pip install playwright pandas
    python -m playwright install chromium
    python scrape_tadawul.py
...
Output goes NEXT TO THIS SCRIPT in tadawul_data/, never into the folder you launched from -
