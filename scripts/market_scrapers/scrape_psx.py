...
# scripts/market_scrapers/psx_data while `consolidate-fundamentals` reads
# <repo>/psx_data - two directories with the same name, one of them invisible to the
...
DATA_DIR = os.environ.get("AERP_DATA_DIR") or os.path.join(_REPO_ROOT, "psx_data")
