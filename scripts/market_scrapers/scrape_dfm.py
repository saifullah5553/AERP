...
# scripts/market_scrapers/dfm_data while `consolidate-fundamentals` reads
# <repo>/dfm_data - two directories with the same name, one of them invisible to the
...
DATA_DIR = os.environ.get("AERP_DATA_DIR") or os.path.join(_REPO_ROOT, "dfm_data")
